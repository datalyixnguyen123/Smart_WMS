...
CONSTRAINT chk_abc_percentage CHECK((min_percentage IS NULL OR (min_percentage >= 0 AND min_percentage <= 100)) AND (max_percentage IS NULL OR(max_percentage >= 0 AND max_percentage <= 100)) AND (min_percentage IS NULL OR max_percentage IS NULL OR min_percentage <= max_percentage)),
...
<<<<<<<< HEAD:database/flyway/V1__master_schema.sql
...
>>>>>>>> f67b2f9d97dac6daa0e56d2109d1df003c6d2303:database/DDL/Master.DDL
