...
VALUES
    ...
    (gen_random_uuid(), 'RC_SUPPLIER_SHORTAGE', 'Supplier Shortage', 'Quantity received is less than the quantity expected from the supplier''s shipment documents.', TRUE)
